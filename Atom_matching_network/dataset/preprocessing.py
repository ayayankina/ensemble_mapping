...
train_data = pd.read_csv("Atom-matching-network/dataset/train.txt", header=None, sep=' ')
...
# редактирует молекулу в соответствии с заданными изменениями
...
if __name__ =='__main__':
    ...
    train_data = pd.read_csv("Atom-matching-network/dataset/train.txt", header=None, sep=' ')
    test_data = pd.read_csv("Atom-matching-network/dataset/test.txt", header=None, sep=' ')
    valid_data = pd.read_csv("Atom-matching-network/dataset/valid.txt", header=None, sep=' ')
